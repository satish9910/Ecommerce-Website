      ...
      <div className="flex justify-between flex-col md:flex-row">
        <div className="w-full md:w-[80%]">
          <div className="flex justify-around uppercase  ">
            {footer.map((val, i) => (
              <div key={i}>
                <div className="text-[12px]  font-semibold mb-2 hover:text-red-500 cursor-pointer">
                  {val.header}
                </div>
                <div className="flex flex-col">
                  {val.title.map((item, key) => (
                    <span className=" text-[8px] sm:text-[10px] md:text-[8px] mr-5 mb-2 hover:text-red-500 cursor-pointer">
                      {item.subtitle}
                    </span>
                  ))}
                </div>
        ...
        <div className="w-full h-[45%] bg-gray-100 rounded-lg p-6 mt-2 shadow-md">
          <h1 className="text-[10px] md:text-[15px]  text-black font-semibold mb-4">SINGN UP FOR NEWSLATTER</h1>
